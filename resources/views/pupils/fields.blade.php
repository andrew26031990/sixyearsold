...
<div class="form-group col-sm-6">
    {!! Form::label('birth_certificate_file', __('message.birth_certificate_file').' (.jpeg, .jpg, .png)( < 2 Mb)') !!}
    {!! Form::file('birth_certificate_file', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255, 'required' => 'required', 'accept' => '.jpeg,.jpg,.png']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('pupils.index') }}" class="btn btn-default">{{__('message.cancel')}}</a>
</div>
